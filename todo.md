...
- [ ] Unit test dengan Jest (target cakupan kritikal ≥ 80%)
- [ ] Kontrak API (`apps/api/tests/contracts`) dan snapshot stabil
- [ ] Tambah perintah uji terarah (mis. `pnpm test apps/api/example.spec.ts`) di CI sebelum merge untuk mencegah Jest menjalankan test yang tidak perlu
