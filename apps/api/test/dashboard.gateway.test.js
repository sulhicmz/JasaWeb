...
describe('DashboardGateway', () => {
    ...
    beforeEach(() => {
        ...
        gateway = new DashboardGateway(mockCacheManager, mockJwtService, mockPrismaService);
    ...
    describe('handleConnection', () => {
        it('should authenticate client with valid token', async () => {
            ...
            expect(mockClient.emit).toHaveBeenCalledWith('initial-data', expect.any(Object));
        });
    ...
    describe('handleSubscribeDashboard', () => {
        ...
        it('should subscribe to dashboard updates', async () => {
            await gateway.handleSubscribeDashboard({ organizationId: 'org-123' }, mockClient);
            expect(mockClient.join).toHaveBeenCalledWith('org-org-123');
        ...
        it('should reject subscription to different organization', async () => {
            await expect(gateway.handleSubscribeDashboard({ organizationId: 'different-org' }, mockClient)).rejects.toThrow('Unauthorized');
        });
    });
    ...
    describe('getDashboardStats', () => {
        ...
        it('should fetch fresh stats if not cached', async () => {
            ...
            expect(mockCacheManager.set).toHaveBeenCalledWith('dashboard-stats-org-123', expect.any(Object), 120000);
        });
    });
...
//# sourceMappingURL=dashboard.gateway.test.js.map