...
describe('DashboardController', () => {
    ...
    describe('getDashboardStats', () => {
        it('should return cached stats if available', async () => {
            ...
            expect(mockCacheManager.get).toHaveBeenCalledWith('dashboard-stats-org-123');
        });
        it('should fetch fresh stats and cache them', async () => {
            ...
            expect(mockCacheManager.set).toHaveBeenCalledWith('dashboard-stats-org-123', expect.any(Object), 300000);
        });
    ...
    describe('getRecentActivity', () => {
        ...
        it('should limit results to specified number', async () => {
            ...
            expect(mockPrismaService.project.findMany).toHaveBeenCalledWith(expect.objectContaining({ take: 1 }));
        });
    });
    ...
    describe('notifyDashboardUpdate', () => {
        it('should broadcast update via WebSocket gateway', async () => {
            ...
            expect(mockDashboardGateway.broadcastDashboardUpdate).toHaveBeenCalledWith({
                type: 'project',
    ...
    describe('refreshDashboardCache', () => {
        it('should clear cache and broadcast refresh event', async () => {
            ...
            expect(mockCacheManager.del).toHaveBeenCalledWith('dashboard-stats-org-123');
            expect(mockCacheManager.del).toHaveBeenCalledWith('dashboard-activity-org-123');
            expect(mockCacheManager.del).toHaveBeenCalledWith('dashboard-projects-org-123');
            expect(mockDashboardGateway.broadcastDashboardUpdate).toHaveBeenCalledWith({
                type: 'stats',
                data: { action: 'refresh' },
                timestamp: expect.any(Date),
