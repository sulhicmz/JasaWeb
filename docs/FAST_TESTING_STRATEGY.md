...
- E2E tests: `*.e2e.test.ts` (using Playwright)
...
- **Timeout errors**: Increase timeout in jest.config.js or use jest.setTimeout()
- **Import errors**: Check tsconfig paths and module resolution
- **Database errors**: Use test database and proper cleanup
