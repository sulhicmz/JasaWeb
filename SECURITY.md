...
#### 2025-11-17: Critical Dependencies Vulnerabilities (Issue #282)

**Fixed Vulnerabilities:**

- **html-minifier** REDoS vulnerability (GHSA-pfq8-rq6v-vf5m) → Replaced with html-minifier-terser@7.2.0
- **js-yaml** prototype pollution (GHSA-mh29-5h37-fv8m) → Updated to 4.1.1
- **nodemailer** email domain misinterpretation (GHSA-mm7p-fcc7-pg87) → Updated to 7.0.10

**Resolution Method:**

- Applied pnpm overrides in root package.json
- Verified all vulnerabilities resolved via `pnpm audit`
- Maintained backward compatibility with no breaking changes
- Updated lockfile to ensure consistent dependency resolution
